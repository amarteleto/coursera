package br.com.marteleto.coursera.forum.test.util;
...
public class ServletMock implements Serializable {
	...
	@Mock private HttpServletResponse httpServletResponseMock;
	...
	private void mockUrls() {
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_LOGIN)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_USUARIO_CADASTRO)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_USUARIO_RANKING)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_TOPICO_CADASTRO)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_LISTAR_TOPICO)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_JSP_CONSULTAR_TOPICO)).thenReturn(requestDispatcherMock);
		Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_SLT_LISTAR_TOPICO)).thenReturn(requestDispatcherMock);
        Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_SLT_RANKING_USUARIO)).thenReturn(requestDispatcherMock);
        Mockito.when(httpServletRequestMock.getRequestDispatcher(WebUtil.URL_SLT_CONSULTAR_TOPICO)).thenReturn(requestDispatcherMock);
	}
	...
	public static HttpServletResponse getHttpServletResponse() {
		return getInstance().httpServletResponseMock;
	}
